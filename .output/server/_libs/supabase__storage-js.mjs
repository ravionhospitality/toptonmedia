...
const resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./@supabase/node-fetch.mjs").then(function(n) {
      return n.i;
...
const resolveResponse = () => __awaiter$3(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./@supabase/node-fetch.mjs").then(function(n) {
      return n.i;
    })).Response;
  }
  return Response;
...
const handleError = (error, reject) => __awaiter$2(void 0, void 0, void 0, function* () {
