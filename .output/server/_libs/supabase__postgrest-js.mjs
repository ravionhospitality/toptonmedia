...
import { r as requireLib } from "./@supabase/node-fetch.mjs";
var cjs = {};
...
function requirePostgrestError() {
  if (hasRequiredPostgrestError) return PostgrestError;
  hasRequiredPostgrestError = 1;
  Object.defineProperty(PostgrestError, "__esModule", { value: true });
  ...
  PostgrestError.default = PostgrestError$1;
...
function requireVersion() {
  ...
  version.version = "0.0.0-automated";
  return version;
}
