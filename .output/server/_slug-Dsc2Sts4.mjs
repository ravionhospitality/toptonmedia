...
import { m as Route$5, d as CASE_STUDIES, S as SiteNav, a as SiteFooter } from "./_ssr/router-BffqhL8K.mjs";
import { F as FAQAccordion } from "./_ssr/FAQAccordion-C7GoqvOZ.mjs";
import { R as Reveal } from "./_ssr/useReveal-BmGG_t8w.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-gold/15 flex items-center justify-center", children: Icon && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 24, className: "text-gold", strokeWidth: 1.5 }) }),
