...
import { l as Route } from "./_ssr/router-VSIbab2f.mjs";
...
function EditPostPage() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-charcoal text-ivory flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ivory/50", children: "Loading…" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-charcoal text-ivory", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold", children: "Edit Blog Post" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Hero Image URL", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: form.heroImage, onChange: (e) => update("heroImage", e.target.value), className: "admin-input" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Excerpt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: form.excerpt, onChange: (e) => update("excerpt", e.target.value), rows: 2, className: "admin-input" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Content Sections (JSON)", hint: 'Format: [{"heading": "...", "paragraphs": ["..."], "bullets": ["..."]}]', children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: form.contentRaw, onChange: (e) => update("contentRaw", e.target.value), rows: 12, className: "admin-input font-mono text-xs" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "FAQs (JSON)", hint: 'Format: [{"question": "...", "answer": "..."}]', children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: form.faqsRaw, onChange: (e) => update("faqsRaw", e.target.value), rows: 6, className: "admin-input font-mono text-xs" }) }),
