...
import { S as SiteNav, g as SERVICES, f as STATS, H as HOW_WE_WORK, h as RETAINER_PACKAGES, C as CONTACT, a as SiteFooter } from "./router-BffqhL8K.mjs";
...
import { A as ArrowRight, o as ArrowDown, p as Check, m as ArrowUpRight } from "../_libs/lucide-react.mjs";
...
function formatValue(val, current) {
...
function StatCounter({ value, label }) {
  ...
  const [current, setCurrent] = reactExports.useState(target);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-4xl sm:text-5xl font-extrabold text-gold mb-2", children: formatValue(value, current) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-ivory/60 uppercase tracking-widest font-[Space_Grotesk]", children: label })
  ] });
}
const CLIENT_LOGOS = [{
  name: "Utiva",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/utivacolored.7364336b.svg"
}, {
  name: "FxBud",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/fxbud_logo%20(1).svg"
}, {
  name: "Hara",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/hara.png"
}, {
  name: "Dantown",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/dantown.jpg"
}, {
  name: "Credite Capital Finance",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/credite.png"
}, {
  name: "KCMFB Limited",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/kcmfb.jpeg"
}, {
  name: "Trendy Lady Barber",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/TRENDY%20BARBER%20png.png"
}, {
  name: "Broadshift",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/broadshift-BR_9oZOd.png"
}, {
  name: "Hootsuite",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/Hootsuite.6f43348b.png"
}, {
  name: "Thrive Agric",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/thrive_agric.e92719e7.jpeg"
}, {
  name: "Kuda Bank",
  url: "https://ahjhwqcrxcljmenoqyex.supabase.co/storage/v1/object/public/logos/Kuda-Bank.png"
}];
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-6 lg:px-10 pt-16 pb-20 lg:pt-24 lg:pb-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-wrap items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/apply", className: "inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-gradient-to-r from-gold to-gold-bright text-charcoal text-sm font-semibold tracking-wide hover:opacity-90 transition-opacity", children: [
                "See If We're a Fit",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-ivory py-14 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-[Space_Grotesk] text-xs uppercase tracking-[0.12em] text-charcoal/40 text-center mb-10", children: "Brands That Trust Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-track flex items-center gap-14", children: [...CLIENT_LOGOS, ...CLIENT_LOGOS].map((logo, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center justify-center h-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo.url, alt: logo.name, className: "max-h-14 max-w-[160px] w-auto object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300", loading: "lazy" }) }, i)) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "bg-charcoal py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.filter((s) => s.featuredOnHome).map((service, i) => {
