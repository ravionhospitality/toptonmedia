...
import "node:https";
import "node:http2";
const appCss = "/assets/styles-DQQlo64C.css";
const CONTACT = {
...
const $$splitComponentImporter$f = () => import("./team-BuLUn5-Q.mjs");
...
function mapRow(row) {
  return {
    ...
    pricing: row.pricing ?? [],
    pricingNote: row.pricing_note ?? void 0,
    whoFor: row.who_for ?? [],
...
const $$splitComponentImporter$e = () => import("./services-511TydJ9.mjs");
...
const $$splitComponentImporter$d = () => import("./contact-CH-wrmMN.mjs");
...
const $$splitComponentImporter$c = () => import("./case-studies-DNwEnGGU.mjs");
const Route$e = createFileRoute("/case-studies")({
  head: () => ({
    meta: seoMeta({
...
const $$splitComponentImporter$b = () => import("./blog-6gU6Glun.mjs");
async function fetchPublishedPosts() {
  const {
    data
  } = await supabase.from("blog_posts").select("id,slug,title,category,excerpt,hero_image,read_minutes,created_at").eq("published", true).order("created_at", {
    ascending: false
  });
  return data ?? [];
}
...
const $$splitComponentImporter$a = () => import("./apply-CGiCRCiJ.mjs");
const Route$c = createFileRoute("/apply")({
  head: () => ({
    meta: seoMeta({
...
const $$splitComponentImporter$9 = () => import("./about-BIY0njhV.mjs");
...
const $$splitComponentImporter$8 = () => import("./index-C20WfeTU.mjs");
...
const $$splitComponentImporter$7 = () => import("./index-XxKDt3uN.mjs");
async function fetchActiveProducts() {
  const {
    data
  } = await supabase.from("products").select("id,slug,name,product_type,category,short_description,card_image,price_ngn,price_usd,compare_at_price_ngn,compare_at_price_usd,rating,review_count,featured").eq("active", true).order("created_at", {
    ascending: false
  });
  return data ?? [];
}
  ...
  head: () => ({
    ...
    scripts: [{
      ...
      children: JSON.stringify(breadcrumbSchema([{
        ...
        name: "Shop",
        url: "https://toptonmedia.com/shop"
      }]))
    }]
  }),
  loader: async () => {
...
const $$splitComponentImporter$6 = () => import("./index-Q4Sx849B.mjs");
...
const $$splitNotFoundComponentImporter$2 = () => import("../_slug-CKF2mY6c.mjs");
const $$splitComponentImporter$5 = () => import("../_slug-CoxycqLd.mjs");
async function fetchProductBySlug(slug) {
  const {
    data
  } = await supabase.from("products").select("*").eq("slug", slug).eq("active", true).single();
  return data ?? null;
}
const Route$6 = createFileRoute("/shop/$slug")({
  head: async ({
    params
  }) => {
    ...
    return {
      ...
      scripts: [{
        ...
        children: JSON.stringify(breadcrumbSchema([{
          ...
          name: product.name,
          url: `https://toptonmedia.com/shop/${product.slug}`
        }]))
      }]
    };
  },
...
const $$splitComponentImporter$4 = () => import("../_slug-Dsc2Sts4.mjs");
const Route$5 = createFileRoute("/services/$slug")({
  head: async ({
    params
  }) => {
...
const Route$4 = createFileRoute("/rss/xml")({
  loader: async () => {
...
const $$splitComponentImporter$3 = () => import("./confirmation-guMEPg3v.mjs");
const Route$3 = createFileRoute("/order/confirmation")({
...
const $$splitComponentImporter$2 = () => import("../_slug-Bh3Z9YnG.mjs");
...
async function fetchRelatedPosts(currentSlug, category) {
  const {
    data
  } = await supabase.from("blog_posts").select("slug,title,hero_image,category,created_at,excerpt,read_minutes").eq("published", true).eq("category", category).neq("slug", currentSlug).limit(3);
  return data ?? [];
}
async function fetchLatestPosts(currentSlug) {
  const {
    data
  } = await supabase.from("blog_posts").select("slug,title,hero_image,category,created_at,read_minutes").eq("published", true).neq("slug", currentSlug).order("created_at", {
    ascending: false
  }).limit(5);
  return data ?? [];
}
const Route$2 = createFileRoute("/blog/$slug")({
    ...
    return {
      ...
      scripts: [{
        ...
        children: JSON.stringify(breadcrumbSchema([{
          ...
          name: post.category,
          url: `https://toptonmedia.com/blog?category=${post.category}`
        }, {
          name: post.title,
  ...
  loader: async ({
    ...
    const [relatedResult, latestResult] = await Promise.allSettled([fetchRelatedPosts(post.slug, post.category), fetchLatestPosts(post.slug)]);
...
const $$splitComponentImporter$1 = () => import("./new-C5vvwrTb.mjs");
const Route$1 = createFileRoute("/admin/blog/new")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_id-CNxW-qi3.mjs");
...
const CaseStudiesRoute = Route$e.update({
  id: "/case-studies",
  path: "/case-studies",
  getParentRoute: () => Route$i
});
...
const ApplyRoute = Route$c.update({
  id: "/apply",
  path: "/apply",
  getParentRoute: () => Route$i
});
...
const SitemapXmlRoute = Route$7.update({
  id: "/sitemap/xml",
  path: "/sitemap/xml",
  getParentRoute: () => Route$i
});
const ShopSlugRoute = Route$6.update({
  id: "/shop/$slug",
  path: "/shop/$slug",
  getParentRoute: () => Route$i
});
const ServicesSlugRoute = Route$5.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => ServicesRoute
});
const RssXmlRoute = Route$4.update({
  id: "/rss/xml",
  path: "/rss/xml",
  getParentRoute: () => Route$i
});
const OrderConfirmationRoute = Route$3.update({
...
export {
  ...
  TEAM as T,
  SiteFooter as a,
  SERVICE_CATEGORIES as b,
  CONTACT_FAQS as c,
  CASE_STUDIES as d,
  Route$d as e,
  STATS as f,
  SERVICES as g,
  RETAINER_PACKAGES as h,
  TICKER_ITEMS as i,
  Route$9 as j,
  createSsrRpc as k,
  Route$6 as l,
