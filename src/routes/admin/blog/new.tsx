        ...
        <div className="space-y-5">
          <Field label="Title *">
            <input
              ...
              placeholder="How to Reduce App Install Cost in Nigeria"
            />
          </Field>

          <Field label="Slug *" hint="Auto-generated from title, edit if needed">
            <input
              value={form.slug}
              onChange={e => update('slug', slugify(e.target.value))}
              className="admin-input"
              placeholder="reduce-app-install-cost-nigeria"
            />
          </Field>
          ...
          <Field label="Hero Image URL">
            <input value={form.heroImage} onChange={e => update('heroImage', e.target.value)} className="admin-input" placeholder="https://..." />
          </Field>

          <Field label="Excerpt" hint="Shown on blog index and at top of post">
          ...
          <Field label="Keywords" hint="Comma-separated">
            <input value={form.keywords} onChange={e => update('keywords', e.target.value)} className="admin-input" placeholder="app install cost Nigeria, CPI Nigeria" />
          </Field>
          ...
          <Field label="Content Sections (JSON)" hint='Format: [{"heading": "...", "paragraphs": ["..."], "bullets": ["..."]}]'>
            <textarea
              ...
              placeholder='[{"heading": "Why This Matters", "paragraphs": ["First paragraph...", "Second paragraph..."]}]'
            />
          </Field>
          ...
          <Field label="FAQs (JSON)" hint='Format: [{"question": "...", "answer": "..."}]'>
            <textarea
              value={form.faqsRaw}
              onChange={e => update('faqsRaw', e.target.value)}
              rows={6}
              className="admin-input font-mono text-xs"
