...
export const BLOG_POSTS_BATCH_1: BlogPost[] = [
  // ─────────────────────────── USER ACQUISITION (4) ───────────────────────────
  {
    ...
    quickAnswer: 'Reduce app install cost in Nigeria by tightening audience targeting to activated-user lookalikes, refreshing ad creative 5-10 times per month, and tracking activation events rather than raw installs. Well-optimised campaigns typically run ₦800-₦2,000 CPI.',
  ...
  },
  {
    ...
    quickAnswer: 'Meta generally performs better for users 28+ and B2B-adjacent products, while TikTok wins for under-28 audiences when creative is built natively for the platform rather than repurposed from other channels.',
  ...
  },
  {
    ...
    quickAnswer: 'Fintech user acquisition in Nigeria should optimise toward activation events like first transaction or completed KYC, not raw installs, and use trust-focused creative (testimonials, compliance messaging) rather than generic feature ads.',
  ...
  },
  {
    ...
    quickAnswer: 'Win back churned Nigerian app users by segmenting based on why they left (never activated vs early churn vs long-dormant), then allocating 15-25% of total acquisition budget toward reactivation campaigns.',
  ...
  // ─────────────────────────── LEAD GENERATION (4) ───────────────────────────
  {
    ...
    quickAnswer: 'Effective B2B lead generation in Nigeria depends more on fast follow-up (within the first hour) and CRM-integrated lead scoring than on lead volume alone. LinkedIn and WhatsApp follow-up consistently outperform email-only approaches.',
  ...
  },
  {
    ...
    quickAnswer: 'The biggest landing page mistakes killing Nigerian lead conversion are asking for too much information upfront, slow load times on mobile data, and multiple competing calls to action instead of one clear next step.',
  ...
  },
  {
    ...
    quickAnswer: 'Nigerian SME CRM rollouts fail when the tool is configured with generic default fields instead of the team’s actual sales process. Match the CRM to your workflow, integrate WhatsApp, and limit required fields to ensure adoption.',
  ...
  },
  {
    ...
    quickAnswer: 'Most leads are not ready to buy immediately. A 2-4 week nurture sequence combining email (for case studies) and WhatsApp (for quick check-ins) keeps Nigerian leads warm until they are ready to convert.',
  ...
  // ─────────────────────────── PERFORMANCE MARKETING (2 of 4 — remainder in batch 2) ───────────────────────────
  {
    ...
    quickAnswer: 'Calculate ROAS by reconciling platform-reported revenue against your actual order or payment system, and judge it against your breakeven ROAS (1 divided by gross margin), not against a generic "good" benchmark.',
  ...
  },
  {
    ...
    quickAnswer: 'Allocate paid media budget by funnel stage rather than splitting evenly: weight Google Search toward high-intent categories with existing search demand, and Meta/TikTok toward awareness for newer brands.',
