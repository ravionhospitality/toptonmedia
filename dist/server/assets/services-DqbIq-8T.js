...
import { Users, Target, BarChart3, LineChart, Palette, Mail, Search, Globe, Megaphone, ArrowRight } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col bg-ivory", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("section", { className: "bg-charcoal pt-20 pb-24 lg:pt-28 lg:pb-32", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-[0.25em] text-gold mb-5", children: "Services" }),
        /* @__PURE__ */ jsxs("h1", { className: "font-display text-5xl sm:text-6xl lg:text-7xl font-semibold leading-[1.04] tracking-tight text-ivory max-w-4xl", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-gold italic", children: "Without the headcount." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-8 text-lg text-ivory/60 max-w-2xl leading-relaxed", children: "We work as an embedded performance marketing team — planning strategy, running campaigns, and building the assets that make them work. You get the output of a full team at a fraction of the cost." })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "h-px bg-gradient-to-r from-transparent via-gold to-transparent" }),
      /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-24", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.map((s) => {
        const Icon = s.icon;
        return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl p-8 border border-sand hover:border-maroon/30 hover:shadow-lg transition-all group", children: [
          /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-maroon/10 flex items-center justify-center mb-6 group-hover:bg-maroon/15 transition-colors", children: /* @__PURE__ */ jsx(Icon, { size: 22, className: "text-maroon", strokeWidth: 1.5 }) }),
          /* @__PURE__ */ jsx("h3", { className: "font-display text-xl font-semibold text-charcoal mb-2", children: s.title }),
          /* @__PURE__ */ jsx("p", { className: "text-charcoal/60 leading-relaxed mb-6 text-sm", children: s.summary }),
          /* @__PURE__ */ jsx("ul", { className: "space-y-2 border-t border-sand pt-5", children: s.points.map((point) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2.5 text-sm text-charcoal/70", children: [
            /* @__PURE__ */ jsx("span", { className: "mt-1.5 w-1.5 h-1.5 rounded-full bg-gold flex-shrink-0" }),
            point
          ] }, point)) })
        ] }, s.title);
      }) }) }),
      /* @__PURE__ */ jsx("section", { className: "bg-charcoal py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-[0.2em] text-gold mb-5", children: "How it works" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl sm:text-5xl font-semibold text-ivory tracking-tight mb-16 max-w-2xl", children: "From onboarding to your first win in under 3 weeks." }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: PROCESS.map((p) => /* @__PURE__ */ jsxs("div", { className: "border-t border-ivory/15 pt-8", children: [
          /* @__PURE__ */ jsx("span", { className: "font-mono text-3xl font-bold text-gold/30", children: p.step }),
          /* @__PURE__ */ jsx("h3", { className: "font-display text-xl font-semibold text-ivory mt-4 mb-3", children: p.title }),
          /* @__PURE__ */ jsx("p", { className: "text-ivory/55 text-sm leading-relaxed", children: p.desc })
        ] }, p.step)) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "bg-maroon py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-[0.2em] text-gold/70 mb-5", children: "Ready when you are" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl sm:text-5xl font-semibold text-ivory tracking-tight max-w-3xl mx-auto", children: "Tell us where growth is stuck. We'll tell you how we'd fix it." }),
