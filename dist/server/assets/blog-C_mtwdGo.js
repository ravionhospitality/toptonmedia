  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col bg-ivory", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("section", { className: "bg-charcoal pt-20 pb-24 lg:pt-28 lg:pb-32", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-[0.25em] text-gold mb-5", children: "Insights" }),
        /* @__PURE__ */ jsxs("h1", { className: "font-display text-5xl sm:text-6xl lg:text-7xl font-semibold leading-[1.04] tracking-tight text-ivory max-w-4xl", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-gold italic", children: "inside of the work." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-8 text-lg text-ivory/60 max-w-xl leading-relaxed", children: "No AI fluff. No generic advice. Just what we've actually learned running campaigns for African brands." })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "h-px bg-gradient-to-r from-transparent via-gold to-transparent" }),
      featured && /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-6 lg:px-10 pt-16 pb-8", children: /* @__PURE__ */ jsx("div", { className: "bg-charcoal rounded-3xl overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-10 lg:p-14 flex flex-col justify-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("span", { className: "px-3 py-1 rounded-full bg-maroon text-ivory text-xs font-semibold", children: featured.category }),
            /* @__PURE__ */ jsx("span", { className: "font-mono text-xs text-gold/60", children: "Featured" })
          ] }),
          /* @__PURE__ */ jsx("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-ivory leading-tight mb-5", children: featured.title }),
          /* @__PURE__ */ jsx("p", { className: "text-ivory/60 leading-relaxed mb-8", children: featured.excerpt }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-xs text-ivory/40 mb-8", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-maroon/40 h-64 lg:h-auto flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center px-8", children: [
          /* @__PURE__ */ jsx("p", { className: "font-display text-5xl font-bold text-gold/20", children: "2025" }),
          /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-ivory/30 mt-2", children: "Performance Marketing" })
        ] }) })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-8", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: CATEGORIES.map((cat) => /* @__PURE__ */ jsx("button", { onClick: () => setActiveCategory(cat), className: `px-4 py-2 rounded-full text-xs font-semibold tracking-wide border transition-colors ${cat === activeCategory ? "bg-maroon text-ivory border-maroon" : "bg-white text-charcoal/60 border-sand hover:border-maroon hover:text-maroon"}`, children: cat }, cat)) }) }),
      /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-6 lg:px-10 pb-24", children: filtered.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-charcoal/40 text-sm py-12 text-center", children: "No posts in this category yet." }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: filtered.map((post) => /* @__PURE__ */ jsxs("article", { className: "bg-white rounded-2xl overflow-hidden border border-sand hover:shadow-lg transition-shadow group", children: [
        /* @__PURE__ */ jsx("div", { className: "bg-sand/40 h-44 flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "font-display text-3xl font-bold text-charcoal/10 group-hover:text-charcoal/20 transition-colors", children: post.category }) }),
        /* @__PURE__ */ jsxs("div", { className: "p-7", children: [
          /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 rounded-full bg-maroon/10 text-maroon text-xs font-semibold", children: post.category }),
          /* @__PURE__ */ jsx("h3", { className: "font-display text-xl font-semibold text-charcoal mt-4 mb-3 leading-tight", children: post.title }),
          /* @__PURE__ */ jsx("p", { className: "text-charcoal/55 text-sm leading-relaxed mb-5 line-clamp-3", children: post.excerpt }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-sand pt-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs text-charcoal/40", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-maroon py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-xs uppercase tracking-[0.2em] text-gold/70 mb-5", children: "Stay sharp" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl sm:text-5xl font-semibold text-ivory tracking-tight max-w-2xl mx-auto", children: "Marketing insights for founders who measure in revenue." }),
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-ivory/65 max-w-md mx-auto", children: "One email, twice a month. What we're learning, what's working, and what to avoid in African growth marketing." }),
        /* @__PURE__ */ jsxs("div", { className: "mt-10 flex flex-col sm:flex-row gap-3 max-w-md mx-auto", children: [
          /* @__PURE__ */ jsx("input", { type: "email", placeholder: "your@email.com", className: "flex-1 px-5 py-3.5 rounded-full bg-ivory/10 text-ivory placeholder-ivory/40 border border-ivory/20 focus:outline-none focus:border-gold text-sm" }),
          /* @__PURE__ */ jsx("button", { className: "px-6 py-3.5 rounded-full bg-gold text-charcoal text-sm font-semibold hover:opacity-90 transition-opacity", children: "Subscribe" })
        ] })
      ] }) })
    ] }),
